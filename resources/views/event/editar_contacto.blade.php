...
@section('contacto')
    <div class="container">
    <form action="{{ route('updateContacto') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>  
            @csrf
            <h1><center>Editar contacto</center></h1>
            ...
            <div class="mb-3 position-relative w-100">
                ...
                <input type="text" class="form-control" disabled name="CONTACTO_NOMBRE" value="{{ $contacto->CONTACTO_NOMBRE }}" placeholder="Ingrese el nombre" required
            ...
            <div class="mb-3 position-relative w-25">
                ...
                <input type="text" class="form-control" name="CONTACTO_NUMERO" value="{{ $contacto->CONTACTO_NUMERO }}"  placeholder="Ingrese el celular o telefono" required
                pattern="[0-9]{7,8}">
            ...
            <div class="mb-3 position-relative w-100">
                ...
                <input type="email" class="form-control" name="CONTACTO_EMAIL" value="{{ $contacto->CONTACTO_EMAIL }}" placeholder="Ingrese el correo">
