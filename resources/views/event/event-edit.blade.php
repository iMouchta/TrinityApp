            ...
            <form action="{{ route('update.evento') }}" method="post"  enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                ...
                <div class = "row">
                    ...
                    <div class ="col">
                        ...
                        <input type="text" class="form-control" name="EVENTO_NOMBRE" value="{{ $evento->EVENTO_NOMBRE }}" placeholder="Ingrese el nombre"
                        ...
                        <input type="text" class="form-control" name="EVENTO_COSTO" value="{{$evento->EVENTO_COSTO}}" placeholder="Ingrese el costo" requerid pattern="^[0-9]{1,6}$">
                    ...
                    <div id="requisitos-container">
                        ...
                        <div class="requisito-input">
                            ...
                            <div class ="row g-1">
                                ...
                                <input type="text" value={{$requesito->REQUISITO_NOMBRE}} class="form-control" name="requisitos[REQUISITO_NOMBRE][]" requerid>   
                            </div>
                            @endforeach
                        </div>
                        <br>
