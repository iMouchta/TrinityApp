                ...
                <div class="col-8">
                     ...
                     <div class="col-4 ">
                                     <div class="descripcion">
                                        ...
                                        <img src="{{ asset('as.jpg') }}"  class="afiche" onclick="expandirImagen(this)" alt="Afiche pequeño">
                                        </div>
...
<script>
    function expandirImagen(imagen) {
        ...
        var imagenAmpliadaContenido = document.getElementById("imagenAmpliadaContenido");
