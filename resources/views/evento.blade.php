...
@section('evento')
    <div class="container">
        <div class="row">
            <form action="{{ route('guardarEvento') }}" method="post" enctype="multipart/form-data"
                ...
                <div class = "row">
                    <div class ="col">
                        ...
                        <input type="text" class="form-control" name="EVENTO_NOMBRE" value="{{ old('EVENTO_NOMBRE') }}"
                            placeholder="Ingrese el nombre" required minlength="4" maxlength="200">
                        <div class="valid-feedback">Nombre válido</div>
                        <div class="invalid-feedback">Use un nombre de "minimo de 4 caracteres"</div>
                        ...
                        <div class ="col">
                            ...
                            <input type="text" class="form-control" name="EVENTO_UBICACION"
                                placeholder="Ingrese la ubicación" required minlength="8" maxlength="250">
                ...
                <div>
                    <div id="requisitos-container">
                        ...
                        <div class="requisito-input">
                            <div class = "row" style="width: 99%; max-width: 99%;">
                                <div class ="col">
